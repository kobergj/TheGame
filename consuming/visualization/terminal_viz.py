...
class MainScreen():
    ...
    def __call__(self, Player, active_sec=None, avail_secs=None, active_anmy=None):
        ...
        print '\n' * 100
        print self.showCurrentStats(Player)
        print self.showAnomalyInfo(active_anmy)
    ...
    def generateSectionsString(self, availableSections):
    ...
    def generateInteractionString(self, Section):
        # Build Information
        interactionInfo = ''
    ...
    def insertWindowInMap(self, raw_info_string):
    ...
    def showCurrentStats(self, Player):
    ...
    def showAnomalyInfo(self, Anomaly):
        if not Anomaly:
            return ' '
